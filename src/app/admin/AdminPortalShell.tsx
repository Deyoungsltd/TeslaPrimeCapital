...
/**
 * Executive Governance Portal Shell — interactive chrome for the admin
 * surface (role-gated session verification, governance tabs). The route-level
 * `layout.tsx` wrapper is the server component that owns the `noindex`
 * metadata contract; this component owns behavior only.
 */
